...
class NMF(pyecp.FM_base):
    ...
    def filter_blacklist_LR(self, mode, check_nitem=140, is_stopcomb=False, percentail=1.645, xmin_max=None,
                            segmentation_strategy=('maxlr', 'minlen')[1]):
        """
    ...
    def train(self, rank, N_loop=1,
        ...
        while (count_loop < N_loop):
            ...
            if (self.itr + 1) % trace_opt['delta_bl'] == 0 \
                ...
                if filter_gaps[2] > 0:
                    self.filter_blacklist_LR(1, check_nitem=140, is_stopcomb=True,
                                             segmentation_strategy=filter_strategy)
